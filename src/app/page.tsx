...
import { SearchFilters, Report } from '@/types'; // Assuming Report type is available or needs to be added

export default function Home() {
  const { searchQuery, allReports, loading } = useSearch();
  ...
  }, [searchQuery, yearFilter, statusFilter, allReports]);
